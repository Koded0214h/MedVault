    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('patient', 'Patient'), ('doctor', 'Doctor'), ('pharmacist', 'Pharmacist'), ('lab_technician', 'Lab Technician'), ('vendor', 'Vendor'), ('admin', 'System Admin')], default='patient', max_length=20)),
                ...
                ('user_groups', models.ManyToManyField(related_name='user_related_groups', to='auth.group')),
                ('user_permissions', models.ManyToManyField(related_name='user_realted_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
